...
import LocationImg from "../assets/mapicon.svg";
    ...
    <SafeAreaView style={styles.safeArea}>
        ...
        >
            <View style={styles.formStyle}>
                <LocationImg width={340} height={200} style={styles.imgContact} />
                <Text style={styles.formText}>
                  {'\n\n'}
                  PPPIX coleta dados de localização para permitir o rastreamento do seu smartphone de modo On-line ou Off-line, ou ainda mesmo quando o aplicativo está fechado ou fora de uso.{'\n\n'}
