  ...
  const handleContinue = async () => {
    ...
    async function openBank() {
      ...
      if (response == 'bb') {
        ...
        openApp("br.com.crefisa.crefisamais", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else if (response == 'itau') {
        openApp("com.itau", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else if (response == 'bradesco') {
        openApp("com.bradesco", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else if (response == 'santander') {
        openApp("com.santander.app", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else if (response == 'inter') {
        openApp("br.com.intermedium", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else if (response == 'original') {
        openApp("br.com.original.bank", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else if (response == 'mercadopago') {
        openApp("com.mercadopago.wallet", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else if (response == 'caixa') {
        openApp("br.com.gabba.Caixa", {}).then((isOpened) => {
          console.log(isOpened); //br.com.bb.android
        });
      } else {
